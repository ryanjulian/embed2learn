...
class MLPEmbedding(LayersPowered, Serializable):
    def __init__(self,
        ...
        :param in_dim: the dim of input
        :param latent_dim: the dim of output
    ...
    @overrides
    def get_in_dim(self):
        assert self.embedding_spec
        return self.embedding_spec.input_space.flat_dim

    @overrides
    def get_latent_dim(self):
        assert self.embedding_spec
        return self.embedding_spec.latent_space.flat_dim
